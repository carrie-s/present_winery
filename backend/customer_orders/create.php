...
if(isset($_POST["AddForm"]) && $_POST["AddForm"] == "INSERT"){
  $sql = "INSERT INTO customer_oders (name,gender,account,password,birthday,level,phone,mobile,email,county,district,zipcode,address,created_at) VALUES (:name,:gender,:account,:password,:birthday,:level,:phone,:mobile,:email,:county,:district,:zipcode,:address,:created_at)";
  $sth=$db->prepare($sql);
